 ...
 * -----------------------------------------------------------------------------------
 * 2018/10/15      yangren       1.0             Why & What is modified
 */
public class TestIp {
    public static void main(String[] args) throws IOException {
        // 测试ip 221.232.245.73 湖北武汉
        String ip = "101.81.180.2";
     ...
     */
    public static String getAddresses(String content, String encodingString) throws IOException {
        // 这里调用pconline的接口
     ...
     * @return
     */
    private static String getResult(String urlStr, String content, String encoding) throws IOException {
        URL url = null;
